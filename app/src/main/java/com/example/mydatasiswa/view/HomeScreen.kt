            ...
            is StatusUiSiswa.Success -> {
                if (statusUiSiswa.siswa.isEmpty()) {
                    ...
                    DaftarSiswa(
                        ...
                        onSiswaClick = onSiswaClick // Pass the function directly
                    )
                }
            }
...
fun DaftarSiswa(
    ...
    onSiswaClick: (Int) -> Unit, // Changed to expect an Int
    modifier: Modifier = Modifier
) {
        ...
        items(items = itemSiswa, key = { it.id }) { person ->
            ItemSiswa(
                ...
                modifier = Modifier
                    ...
                    .clickable { onSiswaClick(person.id.toInt()) } // Pass the Int ID
            )
        }
    }
}
